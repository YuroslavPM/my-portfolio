...
function ProfileCard({ highlights }: ProfileCardProps) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute -inset-6 rounded-3xl bg-gradient-to-br from-[var(--accent)]/8 via-[var(--accent)]/4 to-transparent blur-md md:blur-3xl" />
            <div className="absolute -inset-3 rounded-2xl bg-[var(--accent)]/3 blur-sm md:blur-xl" />
            
            {/* Main card with gradient border effect */}
            <div className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-gradient-to-br from-[var(--surface)] via-[var(--surface)] to-[var(--surface-elevated)]/50 backdrop-blur-sm md:backdrop-blur-xl shadow-xl">
                ...
                <div className="relative p-8">
                        ...
                        <div className="flex items-start justify-between mb-6">
                            <div>
                                <motion.p
                                    ...
                                    transition={isMobile ? { duration: 0.2 } : { duration: 0.4, delay: 0.35 }}
                                ...
                                <motion.h3
                                    initial={isMobile ? { opacity: 0 } : { opacity: 0, x: -10 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={isMobile ? { duration: 0.2 } : { duration: 0.4, delay: 0.4 }}
                            ...
                            <motion.span
                                ...
                                transition={isMobile ? { duration: 0.2 } : { duration: 0.4, delay: 0.45 }}
                    ...
                    <div className="space-y-3 mb-8">
                        {highlights.map((highlight, index) => {
                            const highlightAnimation = isMobile
                                ? { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.2 } }
                                : { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.4, delay: 0.5 + index * 0.1 } };
                    ...
                    <div className="relative pt-6 border-t border-[var(--border)]/60">
                        <motion.p
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={isMobile ? { duration: 0.2 } : { duration: 0.4, delay: 0.8 }}
                        ...
                        <div className="space-y-4">
                            {valueProps.map((line, index) => {
                                const valueAnimation = isMobile
                                    ? { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.2 } }
                                    : { initial: { opacity: 0, x: -10 }, animate: { opacity: 1, x: 0 }, transition: { duration: 0.4, delay: 0.85 + index * 0.08 } };
                                ...
                                return (
                                    ...
                                    >
                                    <div className={`flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-[var(--accent)]/15 to-[var(--accent)]/8 text-[var(--accent)] border border-[var(--accent)]/20 shadow-sm ${isMobile ? '' : 'group-hover:scale-110'} transition-transform shrink-0 mt-0.5`}>
    ...
    return (
        <section className="relative overflow-hidden min-h-[90vh] flex items-center px-4 py-24">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -left-10 -top-10 w-80 h-80 bg-[var(--background-accent)]/35 rounded-full blur-md md:blur-3xl" />
                <div className="absolute right-0 top-8 w-[520px] h-[520px] bg-[var(--accent)]/12 rounded-full blur-md md:blur-[120px]" />
                <div className="absolute left-1/3 bottom-0 w-[360px] h-[360px] bg-[var(--accent-hover)]/14 rounded-full blur-md md:blur-[110px]" />
            </div>
